<template>
  <div class="header d-flex justify-content-between align-items-center px-5">
    <p class="h5">Where in the world?</p>
    <div
      class="header-switch d-flex justify-content-between align-items-center"
      @click="$colorMode.preference = switchMode()"
    >
      <svg
        version="1.0"
